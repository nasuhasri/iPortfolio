<section id="contact" class="contact">
    <div class="container">
        ...
        <div class="section-title">
            <h2>Contact</h2>
            <p>If you have anything to ask me or want to count me in for your upcoming projects, you can contact me here:</p>
        </div>
        ...
        <div class="row" data-aos="fade-in">
            ...
            <div class="col-lg-5 d-flex align-items-stretch">
                <div class="info">
                    ...
                    <div style="width: 100%"><iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=Jalan%20Parameswara,%20Bandar%20Hilir,%2078000%20Alor%20Gajah,%20Melaka+(Bandar%20Hilir,%20Melaka)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                <form action="" name="form1" method="post" role="form" class="php-email-form" onsubmit="sendMessage()">
                    <div class="form-row">
