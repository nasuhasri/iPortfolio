        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="assets/img/portfolio/portfolio-1.png" style="height:400px;max-width: 100%;"><br><br>
    ...
    <div class="modal fade" id="secondPort" tabindex="-1" aria-labelledby="secondPortLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="assets/img/portfolio/portfolio-2.png" style="height:400px;max-width: 100%;"><br><br>
    ...
    <div class="modal fade" id="fourthPort" tabindex="-1" aria-labelledby="fourthPortLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="assets/img/portfolio/sem2-c++.png" style="height:400px;max-width: 100%;"><br><br>
    ...
    <div class="modal fade" id="fifthPort" tabindex="-1" aria-labelledby="fifthPortLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="assets/img/portfolio/sem1-c++.png" style="height:400px;max-width: 100%;"><br><br>
    ...
    <div class="modal fade" id="sixthPort" tabindex="-1" aria-labelledby="sixthPortLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="assets/img/portfolio/nodejs-portfolio.png" style="height:400px;max-width: 100%;"><br><br>
